...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'teams/:teamId/players/:playerId', element: <PlanGate feature="Player stats"><S><PlayerStatsPage /></S></PlanGate> },
      { path: 'teams/:teamId/optimizer',        element: <PlanGate feature="Rotation optimizer"><S><RotationOptimizerPage /></S></PlanGate> },
      ...
      { path: 'records',                     element: <PlanGate feature="Career records"><S><RecordsPage /></S></PlanGate> },
      { path: 'history',                     element: <PlanGate feature="Season history"><S><HistoryPage /></S></PlanGate> },
      { path: 'reports',                     element: <PlanGate feature="Analytics & reports"><S><ReportsPage /></S></PlanGate> },
      { path: 'settings',                    element: <S><SettingsPage /></S> },
      { path: 'upgrade',                     element: <S><UpgradePage /></S> },
      { path: 'tools',                       element: <PlanGate feature="Practice tools"><S><ToolsPage /></S></PlanGate> },
