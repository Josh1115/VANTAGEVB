...
export const STAT_GLOSSARY = {
  ...
  lift:         { abbr: 'L',        full: 'Lifts',                      def: 'Contact where the ball is visibly lifted or carried. Penalized at −3.00 per set in VER.' },
  ...
  net:          { abbr: 'NET',      full: 'Net Violations',             def: 'Contacts where the player touches the net during play. Penalized at −3.00 per set in VER.' },
